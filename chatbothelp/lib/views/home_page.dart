/*import 'package:chatbothelp/models/chat_message.dart';
import 'package:chatbothelp/widgets/chat_message_list_item.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void _sendMessage({required String text}) {
    ...
    _addMessage(name: '', text: text, type: ChatMessageType.sent);
  }
